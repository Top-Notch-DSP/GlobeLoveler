...
/*
  ==============================================================================
    File:           SMPLCompStandaloneFilterWindow.h
...
#include "../Source/gui/include/SMPLCompStandaloneInfoPopup.h"
#include "../Source/gui/include/SMPLCompStandaloneLookAndFeel.h"
...
/**
    ...
    @tags{Audio}
*/
class GlobeLovelerPluginHolder    : private AudioIODeviceCallback,
                                  private Timer,
...
public:
    ...
    */
    GlobeLovelerPluginHolder (PropertySet* settingsToUse,
    ...
    ~GlobeLovelerPluginHolder() override
    {
        stopTimer();
    ...
    //==============================================================================
    void showGlobeLovelerInfoDialog() {
        DialogWindow::LaunchOptions o;
        
        // Make info popup, which sizes itself and initializes its GUI elements -KGK
        auto content = std::make_unique<GlobeLovelerInfoPopup>();

        o.content.setOwned (content.release());

        o.dialogTitle                   = TRANS ("GlobeLoveler v" + JUCEApplication::getInstance()->getApplicationVersion() + " Information");
        o.dialogBackgroundColour        = o.content->getLookAndFeel().findColour (ResizableWindow::backgroundColourId);
        o.escapeKeyTriggersCloseButton  = true;
        o.useNativeTitleBar             = true;
        o.resizable                     = false;
    ...
    static GlobeLovelerPluginHolder* getInstance();
...
private:
    ...
    {
        // Creates the PluginProcessor? -KGK
    ...
    */
    ...
    {
    public:
        SettingsComponent (GlobeLovelerPluginHolder& pluginHolder,
    ...
    private:
        //==============================================================================
        GlobeLovelerPluginHolder& owner;
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (GlobeLovelerPluginHolder)
};
...
/**
    ...
    @tags{Audio}
*/
class GlobeLovelerFilterWindow    : public DocumentWindow,
                                  private Button::Listener
{
public:
    //==============================================================================
    typedef GlobeLovelerPluginHolder::PluginInOuts PluginInOuts;
    ...
    */
    GlobeLovelerFilterWindow (const String& title,
          ...
          optionsButton ("Options")
    {
        ...
        pluginHolder.reset (new GlobeLovelerPluginHolder (settingsToUse, takeOwnershipOfSettings,
    ...
    ~GlobeLovelerFilterWindow() override
    {
       #if (! JUCE_IOS) && (! JUCE_ANDROID)
        if (auto* props = pluginHolder->settings.get())
        {
    ...
    void handleMenuResult(int result)
    {
        ...
        case 5:  pluginHolder->showGlobeLovelerInfoDialog(); break;
        default: break;
        }
    }

    static void menuCallback (int result, GlobeLovelerFilterWindow* button)
    {
    ...
    virtual GlobeLovelerPluginHolder* getPluginHolder()    { return pluginHolder.get(); }

    std::unique_ptr<GlobeLovelerPluginHolder> pluginHolder;
...
private:
    ...
    void buttonClicked(Button*) override
    {
        ...
        m.addSeparator();
        m.addItem(5, TRANS("GlobeLoveler Information..."));
    ...
    {
    public:
        MainContentComponent (GlobeLovelerFilterWindow& filterWindow)
    ...
    private:
        ...
        //==============================================================================
        GlobeLovelerFilterWindow& owner;
    ...
    */
    ...
    GlobeLovelerLookAndFeel LAF;

    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (GlobeLovelerFilterWindow)
};

inline GlobeLovelerPluginHolder* GlobeLovelerPluginHolder::getInstance()
{
    ...
    if (PluginHostType::getPluginLoadedAs() == AudioProcessor::wrapperType_Standalone)
    {
        ...
        for (int i = 0; i < numTopLevelWindows; ++i)
            if (auto window = dynamic_cast<GlobeLovelerFilterWindow*> (desktop.getComponent (i)))
